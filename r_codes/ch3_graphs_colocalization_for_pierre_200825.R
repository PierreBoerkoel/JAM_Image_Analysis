...
data_wide_clean1 <- removeOutliers_ch3(data_wide1,'TUBB','Normal','C'); 
...
# Remove Outliers
source('/Users/pierreboerkoel/git/ADImageAnalysis/JAM_Image_Analysis/r_codes/removeOutliers_ch3.R')
data_wide_clean2 <- removeOutliers_ch3(data_wide2,'TUBB','Normal','C'); 
...
png(filename = paste0(mytablepath,'/TUBB Results/','coloc_TUBB_Normal.png')) 
...
png(filename = paste0(mytablepath,'/TUBB Results/','coloc_TUBB_AD.png')) 
